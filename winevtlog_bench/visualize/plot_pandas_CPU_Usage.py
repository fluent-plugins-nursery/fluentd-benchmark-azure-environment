...
df = pd.DataFrame({
    512: length_512['\\\\fluentd-windows\\Process(ruby#1)\\% Processor Time'],
    1024: length_1024['\\\\fluentd-windows\\Process(ruby#1)\\% Processor Time'],
    2048: length_2048['\\\\fluentd-windows\\Process(ruby#1)\\% Processor Time'],
})
